...
import { initAnimationObservers } from '@/utils/animationUtils';
...
const Contact = () => {
  ...
  return (
    <div className="pt-24 pb-16">
      {/* Hero section */}
      <section className="bg-fazio-cream py-12 animate-fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="fade-in-section">
              ...
              <form className="space-y-4">
                <div className="animate-fade-in" style={{ animationDelay: "100ms" }}>
                  ...
                  <input type="text" id="name" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-fazio-green focus:ring-fazio-green sm:text-sm transition-all duration-300 hover:border-fazio-red" />
                </div>
                <div className="animate-fade-in" style={{ animationDelay: "200ms" }}>
                  <label htmlFor="email" className="block text-sm font-medium text-gray-700">Email</label>
                  <input type="email" id="email" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-fazio-green focus:ring-fazio-green sm:text-sm transition-all duration-300 hover:border-fazio-red" />
                </div>
                <div className="animate-fade-in" style={{ animationDelay: "300ms" }}>
                  <label htmlFor="message" className="block text-sm font-medium text-gray-700">Message</label>
                  <textarea id="message" rows={4} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-fazio-green focus:ring-fazio-green sm:text-sm transition-all duration-300 hover:border-fazio-red" />
                </div>
                <Button type="submit" className="bg-fazio-red hover:bg-fazio-light-red animate-fade-in btn-animate" style={{ animationDelay: "400ms" }}>Envoyer</Button>
              </form>
            </div>
            ...
            <div className="fade-in-section">
              ...
              <ul className="space-y-2">
                <li className="flex items-center animate-fade-in" style={{ animationDelay: "200ms" }}>
                ...
                <li className="flex items-center animate-fade-in" style={{ animationDelay: "300ms" }}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 text-fazio-green">
                ...
                <li className="flex items-center animate-fade-in" style={{ animationDelay: "400ms" }}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 text-fazio-green">
      ...
      {/* CTA Section */}
      <section className="bg-fazio-red text-white py-12 animate-on-scroll">
        <div className="container text-center">
          ...
          <Button asChild size="lg" className="bg-white text-fazio-red hover:bg-fazio-cream btn-animate">
            <Link to="/contact">
