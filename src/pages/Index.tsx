        ...
        <div className="container">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="animate-on-scroll h-[400px]">
              <InterventionMap height={400} className="shadow-lg" />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            ...
            <div className="animate-on-scroll p-6 rounded-lg border border-gray-200 bg-fazio-cream/30 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-700 mb-4">
                "La qualité du travail est au rendez-vous. Le carrelage de notre cuisine est impeccable. M. Fazio a su nous conseiller sur le choix des matériaux et le résultat est parfait. Service très professionnel !"
              </p>
              <div className="flex items-center">
                <span className="font-semibold">Sébastien D.</span>
                <span className="mx-2 text-gray-500">•</span>
                <span className="text-gray-500">Lyon</span>
              </div>
            </div>
            ...
            <div className="animate-on-scroll p-6 rounded-lg border border-gray-200 bg-fazio-cream/30 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-700 mb-4">
                "Notre nouvelle salle de bain avec douche à l'italienne est magnifique ! Le projet a été réalisé dans les délais et le budget prévus. Lorenzo est à l'écoute et très professionnel. Je recommande vivement."
              </p>
              <div className="flex items-center">
                <span className="font-semibold">Marie L.</span>
                <span className="mx-2 text-gray-500">•</span>
                <span className="text-gray-500">Dagneux</span>
              </div>
            </div>

            {/* Témoignage 3 - Philippe */}
            <div className="animate-on-scroll p-6 rounded-lg border border-gray-200 bg-fazio-cream/30 hover:shadow-md transition-shadow">
              <div className="flex space-x-1 mb-4">
                <svg className="w-5 h-5 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118l-2.8-2.034c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
              ...
              <p className="text-gray-700 mb-4">
                "Pour la rénovation complète de notre appartement, nous avons fait appel à SARL Fazio. Une équipe réactive, à l'écoute et surtout très compétente. Le travail est propre et soigné. Nous sommes ravis."
              </p>
              <div className="flex items-center">
                <span className="font-semibold">Philippe M.</span>
                <span className="mx-2 text-gray-500">•</span>
                <span className="text-gray-500">Villefranche-sur-Saône</span>
              </div>
            </div>
          </div>
        </div>
