          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            ...
            <div className="animate-on-scroll p-6 rounded-lg border border-gray-200 bg-fazio-cream/30 hover:shadow-md transition-shadow">
              ...
              <p className="italic mb-4">
                "Travail de qualité et dans les délais. La réalisation est conforme au projet, très satisfait du résultat."
              </p>
            ...
            <div className="animate-on-scroll p-6 rounded-lg border border-gray-200 bg-fazio-cream/30 hover:shadow-md transition-shadow">
              ...
              <p className="italic mb-4">
                "Équipe sérieuse et professionnelle. Notre salle de bain est magnifique, merci!"
              </p>
              <div className="font-semibold">
                Marie T. - Bourg-en-Bresse
              </div>
            </div>
            ...
            <div className="animate-on-scroll p-6 rounded-lg border border-gray-200 bg-fazio-cream/30 hover:shadow-md transition-shadow">
              ...
              <p className="italic mb-4">
                "J'ai fait appel à eux pour ma douche à l'italienne et je ne regrette pas mon choix. Travail impeccable."
              </p>
              <div className="font-semibold">
                Pierre L. - Villefranche
              </div>
            </div>
          </div>
        </div>
