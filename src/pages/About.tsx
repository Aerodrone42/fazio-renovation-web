  ...
  return (
    <div className="pt-24 pb-16">
      ...
      <section className="py-16">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-fazio-dark-green mb-4">Notre équipe</h2>
            <p className="text-lg text-gray-700">
              Une équipe de professionnels qualifiés et passionnés, prêts à donner vie à vos projets.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              <div className="h-64 overflow-hidden">
                <img 
                  src="https://images.unsplash.com/photo-1619290463660-80900a1e6a89?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1335&q=80" 
                  alt="Lorenzo Fazio - Fondateur" 
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-1">Lorenzo Fazio</h3>
                <p className="text-fazio-red mb-4">Fondateur & Artisan Carreleur</p>
                <p className="text-gray-600">
                  Plus de 15 ans d'expérience dans la pose de carrelage et la rénovation. Expert en aménagement de salles de bain et douches à l'italienne.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              <div className="h-64 overflow-hidden">
                <img 
                  src="https://images.unsplash.com/photo-1570696425005-0aebdf64e5b9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1480&q=80" 
                  alt="Marc Durand - Plombier" 
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-1">Marc Durand</h3>
                <p className="text-fazio-red mb-4">Plombier Partenaire</p>
                <p className="text-gray-600">
                  Spécialiste en installations sanitaires modernes et économes en eau. Intervient sur nos chantiers de rénovation de salles de bain.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              <div className="h-64 overflow-hidden">
                <img 
                  src="https://images.unsplash.com/photo-1616606103915-dea7be788566?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1287&q=80" 
                  alt="Sophie Martin - Conseillère" 
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-1">Sophie Martin</h3>
                <p className="text-fazio-red mb-4">Conseillère Clientèle</p>
                <p className="text-gray-600">
                  À l'écoute de vos besoins pour vous orienter vers les meilleures solutions. Gère la coordination et le planning des interventions.
                </p>
              </div>
            </div>
          </div>
